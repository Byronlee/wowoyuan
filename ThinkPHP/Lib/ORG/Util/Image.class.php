...
class Image extends Think {//类定义开始
     ...
     * @return string
      +----------------------------------------------------------
     */
    static function buildImageVerify($length=8, $mode=1, $type='png', $width=100, $height=29, $verifyName='verify') {
...
//        @imagestring($im, 5, 5, 3, $randval, $stringColor);
    ...
    // 中文验证码
    static function GBVerify($length=4, $type='png', $width=80, $height=40, $fontface='simhei.ttf', $verifyName='verify') {
        import('ORG.Util.String');
